...
const API_BASE = import.meta.env.VITE_API_BASE_URL || 'http://localhost:5000';
  ...
  const [submissionFeedback, setSubmissionFeedback] = useState({}); // local fallback: `${assignId}-${idx}` -> text
  ...
  // (moved below, after courseAssignmentsData / courseQuizzesData are declared)
  ...
  // Real, admin-registered students for this course (mapped onto the shape
  // the existing table already expects), falling back to the original demo
  // rows only when there's no real data yet.
  // (liveStudentsMapped / effectiveStudentsData moved below, after studentsData is declared)
                  ...
                  {activeCourseTab === 'assignments' && selectedAssignment && (
                    <div className="submission-view-layout animated-fade">
                      ...
                      <div className="submission-split-layout">
                        ...
                        {/* Detail modal — same layout language as the student portal's Assignment Information popup */}
                        {selectedSubmission && (
